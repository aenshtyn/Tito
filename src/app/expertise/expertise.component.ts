...
export class ExpertiseComponent implements OnInit {
  ...
  expertises:Expertise[] = [
    {id:1, name:'Aviation Law', image:'../assets/img/alternate.jpg'},
    ...
    {id:7, name:'Regional & International Law', image:'https://kmco.co.ke/wp-content/uploads/2018/08/x3-1170x777.jpg'},
    {id:8, name:'Property, Conveyancing, Land Landlord & Tenant Law', image:'https://kmco.co.ke/wp-content/uploads/2018/08/x3-1170x777.jpg'},
  ];
